  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        {/* Vagues/Piscine stylisée en bas */}
      ...
      {/* Slogan discret */}
      <div className="fixed bottom-4 right-4 z-10 opacity-40 pointer-events-none hidden md:block">
