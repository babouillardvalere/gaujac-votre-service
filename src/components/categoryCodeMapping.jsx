...
export const getInventaireParCategorie = (categorie, lang = 'fr') => {
  ...
  const INVENTAIRES = {
    ...
    MH_PREMIUM_3CH: [
      ...
      { id: 'eplucheur', icon: '🥕', label_fr: 'Éplucheur', label_en: 'Vegetable peeler', quantity: 1 },
      { id: 'louche', icon: '🍜', label_fr: 'Louche', label_en: 'Ladle', quantity: 1 },
      { id: 'ecumoire', icon: '🥄', label_fr: 'Écumoire', label_en: 'Skimming ladle', quantity: 1 },
      { id: 'planche_decouper', icon: '🔪', label_fr: 'Planche à découper', label_en: 'Cutting board', quantity: 1 },
      { id: 'dessous_plat', icon: '🧤', label_fr: 'Dessous de plat', label_en: 'Table mat', quantity: 1 },
      { id: 'passoire', icon: '🥛', label_fr: 'Passoire', label_en: 'Colander', quantity: 1 },
      { id: 'essoreuse_salade', icon: '🥬', label_fr: 'Essoreuse à salade', label_en: 'Salad spinner', quantity: 1 },
      { id: 'tire_bouchon', icon: '🍷', label_fr: 'Tire-bouchon', label_en: 'Corkscrew', quantity: 1 },
      { id: 'ouvre_boite', icon: '🥫', label_fr: 'Ouvre-boîte', label_en: 'Tin opener', quantity: 1 },
      { id: 'range_couverts', icon: '🍴', label_fr: 'Range couverts', label_en: 'Cutlery tray', quantity: 1 },
      { id: 'plateau', icon: '🍱', label_fr: 'Plateau', label_en: 'Tray', quantity: 1 },
      { id: 'corbeille_pain', icon: '🍞', label_fr: 'Corbeille à pain', label_en: 'Bread basket', quantity: 1 },
      { id: 'plat_four_rond', icon: '🍛', label_fr: 'Plat à four rond', label_en: 'Baking dish', quantity: 1 },
      { id: 'cloche_micro_onde', icon: '🥤', label_fr: 'Cloche micro-onde', label_en: 'Microwave cover', quantity: 1 },
      { id: 'bac_glacons', icon: '🧊', label_fr: 'Bac à glaçon', label_en: 'Ice tray', quantity: 1 },
      ...
      { id: 'poubelle', icon: '🗑️', label_fr: 'Poubelle', label_en: 'Dustbin', quantity: 2 },
      { id: 'detecteur_fumee', icon: '🚨', label_fr: 'Détecteur de fumée', label_en: 'Smoke detector', quantity: 1 },
      { id: 'cle_locatif', icon: '🗝️', label_fr: 'Clé locatif', label_en: 'Key', quantity: 1 },
      { id: 'carte_barriere', icon: '🪪', label_fr: 'Carte Barrière', label_en: 'Barrier card', quantity: 1 },
      { id: 'chaises_interieur', icon: '🪑', label_fr: 'Chaises intérieur', label_en: 'Indoor chairs', quantity: 5 },
      { id: 'table_jardin', icon: '🍽️', label_fr: 'Table de jardin', label_en: 'Garden table', quantity: 1 },
      { id: 'banc_bois', icon: '🌳', label_fr: 'Banc en bois', label_en: 'Wooden bench', quantity: 2 },
      { id: 'chaise_exterieur', icon: '🪑', label_fr: 'Chaise extérieur', label_en: 'Garden chair', quantity: 1 },
      { id: 'transat', icon: '🌞', label_fr: 'Transat', label_en: 'Deck chair', quantity: 2 },
    ...
    MH_PREMIUM_TWINS: [
      ...
      { id: 'chaises_interieur', icon: '🪑', label_fr: 'Chaises intérieur', label_en: 'Indoor chairs', quantity: 4 },
      { id: 'table_jardin', icon: '🍽️', label_fr: 'Table de jardin', label_en: 'Garden table', quantity: 1 },
      { id: 'chaises_jardin', icon: '🪑', label_fr: 'Chaises de jardin', label_en: 'Garden chairs', quantity: 5 },
      { id: 'transat', icon: '🌞', label_fr: 'Transat', label_en: 'Deck chair', quantity: 1 },
      { id: 'table_chevet', icon: '🛏️', label_fr: 'Table de chevet', label_en: 'Nightstand', quantity: 3 },
      { id: 'couette_double', icon: '🛏️', label_fr: 'Couette double', label_en: 'Double blanket', quantity: 1 },
