...
export const getInventaireParCategorie = (categorie, lang = 'fr') => {
  ...
  const INVENTAIRES = {
    CHALET_ECO_1CH: [
      ...
      { id: 'plat', icon: '🍲', label_fr: 'Plat', label_en: 'Presenteer', quantity: 1 },
      { id: 'bols', icon: '🥣', label_fr: 'Bols', label_en: 'Bowls', quantity: 6 },
      { id: 'saladier', icon: '🥗', label_fr: 'Saladiers', label_en: 'Salad bowl', quantity: 1 },
      ...
      { id: 'cuilleres_soupe', icon: '🥄', label_fr: 'Cuillères à soupe', label_en: 'Spoons', quantity: 6 },
      ...
      { id: 'couvert_salade', icon: '🥗', label_fr: 'Couvert à salade', label_en: 'Salad cutlery', quantity: 1 },
      { id: 'ciseaux', icon: '✂️', label_fr: 'Ciseaux', label_en: 'Scissors', quantity: 1 },
      { id: 'spatule_bois', icon: '🥄', label_fr: 'Spatule en bois', label_en: 'Wooden spoon', quantity: 1 },
      { id: 'eplucheur', icon: '🥕', label_fr: 'Eplucheur', label_en: 'Vegetable peeler', quantity: 1 },
      { id: 'louche', icon: '🍜', label_fr: 'Louche', label_en: 'Ladle', quantity: 1 },
      { id: 'ecumoire', icon: '🥄', label_fr: 'Ecumoire', label_en: 'Skimming ladle', quantity: 1 },
      { id: 'planche_decouper', icon: '🔪', label_fr: 'Planche à découper', label_en: 'Cuttingboard', quantity: 1 },
      { id: 'dessous_plat', icon: '🧤', label_fr: 'Dessous de plat', label_en: 'Table mat', quantity: 1 },
      ...
      { id: 'ouvre_boite', icon: '🥫', label_fr: 'Ouvre-boite', label_en: 'Tin opener', quantity: 1 },
      ...
      { id: 'casseroles', icon: '🍲', label_fr: 'Casseroles', label_en: 'Saucepan', quantity: 3 },
      { id: 'poele', icon: '🍳', label_fr: 'Poêle', label_en: 'Frying pan', quantity: 1 },
      { id: 'faitout', icon: '🍲', label_fr: 'Faitout + couvercle', label_en: 'Stew + cover', quantity: 1 },
      { id: 'couvercle', icon: '🔥', label_fr: 'Couvercle', label_en: 'Lid', quantity: 1 },
      { id: 'cafetiere', icon: '☕', label_fr: 'Cafetière électrique', label_en: 'Coffeemaker', quantity: 1 },
      ...
      // Ménage
      { id: 'kit_wc', icon: '🚽', label_fr: 'Kit brosse WC', label_en: 'Toilet Brush', quantity: 1 },
      { id: 'seau', icon: '🪣', label_fr: 'Seau', label_en: 'Bucket', quantity: 1 },
      { id: 'bassine', icon: '🧴', label_fr: 'Bassine', label_en: 'Washbasin', quantity: 1 },
      ...
      { id: 'serpilliere', icon: '🪣', label_fr: 'Serpillère', label_en: 'Floor cloth', quantity: 1 },
      { id: 'sechoir_linge', icon: '👕', label_fr: 'Séchoir à linge', label_en: 'Clothes dryer', quantity: 1 },
      { id: 'pinces_linge', icon: '🧷', label_fr: 'Pinces à linge', label_en: 'Cloth pins', quantity: 8 },
      { id: 'poubelle', icon: '🗑️', label_fr: 'Poubelle', label_en: 'Dustbin', quantity: 1 },
      { id: 'extincteur', icon: '🧯', label_fr: 'Extincteur', label_en: 'Extinguisher', quantity: 1 },
      { id: 'detecteur_fumee', icon: '🚨', label_fr: 'Détecteur de fumée', label_en: 'Smoke detector', quantity: 1 },

      // Nuit
      { id: 'couettes_doubles', icon: '🛏️', label_fr: 'Couettes doubles', label_en: 'Double blankets', quantity: 2 },
      { id: 'couette_simple', icon: '🛏️', label_fr: 'Couette simple', label_en: 'Single blanket', quantity: 1 },
      ...
      // Extérieur
      { id: 'cle_locatif', icon: '🗝️', label_fr: 'Clé locatif', label_en: 'Key', quantity: 1 },
      { id: 'carte_barriere', icon: '🪪', label_fr: 'Carte Barrière', label_en: 'barrier card', quantity: 1 },
      { id: 'banc_bois', icon: '🌳', label_fr: 'Bancs en bois', label_en: 'wooden bench', quantity: 2 },
  ...
  INVENTAIRES.MH_CLASSIQUE_2CH = [
    ...
    // Cuisson / Électroménager
    { id: 'casseroles', icon: '🍲', label_fr: 'Casseroles', label_en: 'Saucepan', quantity: 3 },
    { id: 'poeles', icon: '🍳', label_fr: 'Poêle', label_en: 'Frying pan', quantity: 2 },
    { id: 'faitout', icon: '🍲', label_fr: 'Faitout + couvercle', label_en: 'Stew + cover', quantity: 1 },
    { id: 'couvercle', icon: '🔥', label_fr: 'Couvercle', label_en: 'Lid', quantity: 1 },
    { id: 'cafetiere', icon: '☕', label_fr: 'Cafetière électrique', label_en: 'Coffeemaker', quantity: 1 },
    { id: 'micro_ondes', icon: '📡', label_fr: 'Micro-ondes', label_en: 'Microwave', quantity: 1 },
    ...
    { id: 'sechoir_linge', icon: '👕', label_fr: 'Séchoir à linge', label_en: 'Clothes dryer', quantity: 1 },
    { id: 'pinces_linge', icon: '🧷', label_fr: 'Pinces à linge', label_en: 'Cloth pins', quantity: 8 },
    { id: 'poubelles', icon: '🗑️', label_fr: 'Poubelle', label_en: 'Dustbin', quantity: 2 },
    { id: 'extincteur', icon: '🧯', label_fr: 'Extincteur', label_en: 'Extinguisher', quantity: 1 },
    { id: 'detecteur_fumee', icon: '🚨', label_fr: 'Détecteur de fumée', label_en: 'Smoke detector', quantity: 1 },

    // Nuit
    { id: 'couettes_doubles', icon: '🛏️', label_fr: 'Couettes doubles', label_en: 'Double blankets', quantity: 1 },
    { id: 'couettes_simples', icon: '🛏️', label_fr: 'Couettes simples', label_en: 'Single blankets', quantity: 2 },
    { id: 'oreillers', icon: '🛏️', label_fr: 'Oreillers', label_en: 'Pillows', quantity: 6 },
    { id: 'cintres', icon: '👗', label_fr: 'Cintres', label_en: 'Clothes hangers', quantity: 10 },
    ...
    { id: 'cle_locatif', icon: '🗝️', label_fr: 'Clé locatif', label_en: 'Key', quantity: 1 },
    { id: 'carte_barriere', icon: '🪪', label_fr: 'Carte Barrière', label_en: 'barrier card', quantity: 1 },
    { id: 'chaises_interieur', icon: '🪑', label_fr: 'Chaises intérieurs', label_en: 'Indoor chairs', quantity: 2 },
    { id: 'table_jardin', icon: '🍽️', label_fr: 'Table de jardin', label_en: 'Garden table', quantity: 1 },
    { id: 'chaises_jardin', icon: '🪑', label_fr: 'Chaises de jardin', label_en: 'Garden chairs', quantity: 4 }
  ];
  ...
  INVENTAIRES.MH_PREMIUM_TWINS = [
    ...
    { id: 'micro_ondes', icon: '📡', label_fr: 'Micro-ondes', label_en: 'Microwave', quantity: 1 },
    { id: 'refrigerateur_congelateur', icon: '🧊', label_fr: 'Réfrigérateur-congélateur', label_en: 'Fridge-freezer', quantity: 1 },
    { id: 'tv', icon: '📺', label_fr: 'TV salon', label_en: 'Living room TV', quantity: 1 },
    { id: 'tv_chambre', icon: '📺', label_fr: 'TV chambre', label_en: 'Bedroom TV', quantity: 1 },
    { id: 'telecommande_clim', icon: '❄️', label_fr: 'Télécommande climatisation', label_en: 'AC remote', quantity: 1 },
    { id: 'lave_vaisselle', icon: '🍽️', label_fr: 'Lave-vaisselle', label_en: 'Dishwasher', quantity: 1 },
    { id: 'plancha', icon: '🔥', label_fr: 'Plancha', label_en: 'Plancha grill', quantity: 1 },
  ...
  INVENTAIRES.COTTAGE_PREMIUM = [
    ...
    { id: 'refrigerateur', icon: '🧊', label_fr: 'Réfrigérateur', label_en: 'Fridge', quantity: 1 },
    { id: 'lave_vaisselle', icon: '🍽️', label_fr: 'Lave-Vaisselle', label_en: 'dishwasher', quantity: 1 },
    { id: 'egouttoir', icon: '🥤', label_fr: 'Egouttoir', label_en: 'Dish rack', quantity: 1 },
    ...
    // Extérieur
    { id: 'cle_locatif', icon: '🗝️', label_fr: 'Clé locatif', label_en: 'Key', quantity: 2 },
    { id: 'carte_barriere', icon: '🪪', label_fr: 'Carte Barrière', label_en: 'barrier card', quantity: 1 },
    { id: 'chaises_interieur', icon: '🪑', label_fr: 'Chaises intérieur', label_en: 'Indoor chairs', quantity: 3 },
    { id: 'table_jardin', icon: '🍽️', label_fr: 'Table de jardin', label_en: 'Garden table', quantity: 1 },
    { id: 'chaises_jardin', icon: '🪑', label_fr: 'Chaises de jardin', label_en: 'Garden chairs', quantity: 4 }
  ];
