...
/* ============================================================
   MH ECO - INVENTAIRE COMPLET (H01 à H16)
============================================================ */

const INVENTAIRE_ECO = {
  vaisselle: [
  ...
  menage: [
    ...
    { id: 'extincteur', emoji: '🧯', label: 'Extincteur', qty: 1, service: 'MENAGE' },
  ...
  exterieur: [
    ...
    { id: 'tabourets', emoji: '🪑', label: 'Tabourets', qty: 2, service: 'TECHNIQUE' },
...
export default function ClientControleInventaireEco() {
  ...
  const allItems = useMemo(() => {
    return [
      ...INVENTAIRE_ECO.vaisselle,
      ...INVENTAIRE_ECO.couverts,
      ...INVENTAIRE_ECO.batterie,
      ...INVENTAIRE_ECO.appareils,
      ...INVENTAIRE_ECO.sanitaires,
      ...INVENTAIRE_ECO.menage,
      ...INVENTAIRE_ECO.literie,
      ...INVENTAIRE_ECO.exterieur
    ];
  }, []);
  ...
  const createInterventionEco = async ({ service, items, ficheId }) => {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      await createInterventionEco({ service: "MENAGE", items: menage, ficheId: fiche.id });
      await createInterventionEco({ service: "TECHNIQUE", items: technique, ficheId: fiche.id });
  ...
  return (
    <div className="min-h-screen max-w-4xl mx-auto px-6 py-8">
      ...
      <p className="text-center text-gray-600 mb-6">
        MH Éco {mh} • {nom} {prenom}
      </p>

      {Object.entries(INVENTAIRE_ECO).map(([section, items]) => (
            ...
            <h3 className="font-semibold text-[#0077A8] mb-3 capitalize">
              {lang === "fr" 
                ? section === 'vaisselle' ? '🍽️ Cuisine / Vaisselle' 
                  ...
                  : section === 'literie' ? '🛏️ Chambres & Rangement'
