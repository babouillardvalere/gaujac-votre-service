...
export default function ClientDepartHebergement() {
  ...
  const handleSubmit = () => {
    ...
    sessionStorage.setItem('depart_categorie', categorie);
    sessionStorage.setItem('depart_numero', numero);
      ...
      <div className="max-w-lg mx-auto">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center justify-between mb-4">
            <button
              onClick={() => step === 1 ? navigate(createPageUrl('ClientDepartIdentite')) : setStep(1)}
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <Card 
                  className="border-2 border-[#FFA500]/30 hover:border-[#FFA500] cursor-pointer transition-all rounded-xl"
                  onClick={() => handleTypeSelection('mobilhome')}
                >
                  <CardContent className="p-6">
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 bg-[#FFA500] rounded-xl flex items-center justify-center">
                  ...
                  <CardContent className="p-6 space-y-4">
                    <div>
                      ...
                      <Select value={categorie} onValueChange={setCategorie}>
                        <SelectTrigger className="border-2 border-gray-200 focus:border-[#FFA500] rounded-xl">
