...
/* ============================================================
   MH CONFORT 3CH - INVENTAIRE COMPLET (F01 à F04)
============================================================ */
...
export default function ClientControleInventaireConfort3ch() {
  ...
  const allItems = useMemo(() => {
    return [
      ...INVENTAIRE_CONFORT_3CH.vaisselle,
  ...
  const createInterventionConfort = async ({ service, items, ficheId }) => {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      await createInterventionConfort({ service: "TECHNIQUE", items: technique, ficheId: fiche.id });
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-md space-y-6">
          ...
          <h2 className="text-2xl font-bold text-[#0077A8]">
            {lang === "fr" 
              ? `Nous vous remercions pour le retour concernant votre hébergement. Nous espérons que vous passerez un excellent séjour parmi nous ${nom} ${prenom}.`
              : `Thank you for your feedback. We hope you have an excellent stay with us ${nom} ${prenom}.`
            }
          </h2>
  ...
  return (
    <div className="min-h-screen max-w-4xl mx-auto px-6 py-8">
      ...
      {Object.entries(INVENTAIRE_CONFORT_3CH).map(([section, items]) => (
