                ...
                <CardContent>
                  <div className="space-y-3">
                    {[
                      ...
                      { label: 'Entre 3h et 24h', value: moins24h, color: 'bg-[#00AEEF]', pct: resolus.length > 0 ? Math.round(moins24h / resolus.length * 100) : 0 },
                      { label: 'Plus de 3 jours', value: plus3j, color: 'bg-red-500', pct: resolus.length > 0 ? Math.round(plus3j / resolus.length * 100) : 0 }
                    ].map(cat => (
                      <div key={cat.label}>
